...
/**
 * <code>{@link ShardingSphereAutoConfiguration}</code>
 *
 * @author crisis
 */
@Configuration
...
public class ShardingSphereAutoConfiguration implements EnvironmentAware {
    ...
    static {
        NewInstanceServiceLoader.register(SQLTokenGenerator.class);
        NewInstanceServiceLoader.register(ParameterRewriter.class);
    }
    ...
    public DataSource shardingDataSource() throws SQLException {
        return new ShardingDataSource(dataSourceMap, new ShardingRule(new ShardingRuleConfigurationYamlSwapper().swap(shardingRule), dataSourceMap.keySet()), props.getProps());
    }
